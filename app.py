from flask import Flask, render_template,request,redirect,url_for,jsonify,abort,g # For flask implementation
...
@app.before_request
def check_crashed():
	print("Checking if app crashed")

	if app_crashed:
        # Abort all requests with a 500 Internal Server Error
...
# Optional: Endpoint to simulate failure
@app.route('/crash')
def crash():
    global app_crashed
    app_crashed = True
